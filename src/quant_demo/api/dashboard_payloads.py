...
STRATEGIES = {
    ...
    "聚宽微盘 Alpha（月历暴跌加仓）": ROOT / "configs" / "strategy" / "joinquant_microcap_alpha_calendar_crash.yaml",
...
def _build_joinquant_microcap_report_text(
    ...
    report_title_map = {
        ...
        "joinquant_microcap_alpha_cc": "聚宽微盘 Alpha（月历暴跌加仓）回测报告",
...
def connection_state(settings: AppSettings, probe: dict[str, Any] | None, data: DashboardData | None = None) -> dict[str, str]:
    if data is not None and _is_joinquant_microcap_dashboard(data):
        ...
        detail_map = {
            ...
            "joinquant_microcap_alpha_cc": "当前页面展示 joinquant_microcap_alpha_cc 的本地回测产物。",
